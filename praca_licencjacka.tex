...
Do sprawdzania wejścia z klawiatury i myszki od gracza używam funkcjonalności,
którą \textit{pygame} dodaje do biblioteki SDL. Sprawdzenie, czy gracz wcisnął
%tutaj czy gracz wscinal esc i jak to sie sprwdza
lewy przycisk myszy jest sprawdzane w metodzie \textit{update} obiekt ptaka i
polega na sprawdzeniu dwóch warunków:
\begin{itemize}
...
wciśnięcie lewego przycisku myszy powodowałoby, że ptak podlatywał by do góry
o dużą ilość jednostek, dopóki przycisk nie zostałby zwolniony.
