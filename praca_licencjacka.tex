...
co wywołanie metody update inkrementuję zmienną która mówi nam o ile ma
...
obrazek. Po wczytaniu obrazku w konstruktorze używam metody \textit{get\_rect}
...
\[W, H -  \]
Gdzie $W$ to szerokość tła ustalona na początku, $H$ to wysokość tła
% w kodzie to jest w linikach 33 i 210
