...
Q-learning został wprowadzony przez Chrisa Watkinsa w 1989 roku w jego pracy
doktorskiej zatytułowanej : ``Learning from Delayed
...
Q[s,a]\right) \]
albo, równoważnie
\[Q[s,a] := (1 - \alpha) * A[s,a] + \alpha * \left(r + \gamma \max_{a'}
Q[s',a'] \right)\]
