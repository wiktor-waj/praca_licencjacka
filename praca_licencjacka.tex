...
W rozdziale ``\nameref{chapter:gra}'' przedstawię jaką grę ``Flappy Bird'',
opiszę jej
...
\[P_f = 900 * (30 \div F)\]
gdzie $F$ to FPS (domyślnie $30$ stąd ta liczba we wzorze)
...
hitboxu obiektu dolnej rury. Jeżeli tak się stało ustawiam flagę dla
